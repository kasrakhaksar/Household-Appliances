from django.db.models import Model, Index, CharField, TextField, DecimalField, CASCADE, ForeignKey, PositiveIntegerField, BooleanField, ImageField, DateTimeField
...
class ProductImage(Model):
    ...
    alt_text = CharField(max_length=255, null=True, blank=True)
